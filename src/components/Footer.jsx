...
const Footer = () => {
  return (
    <div className='footer-container'>
        <div>
            <h5>Company and teams</h5>
            <p>Company and teams</p>
            <p>Security</p>
            <p>Press</p>
            <p>Career</p>
            <p>Service Status</p>
            ...
            <p>Mission Roadmap</p>
            <p>Affliate and Partnership</p>
            <p>Help center</p>
            <p>Review</p>
        </div>
        <div>
            <h5>Vision Products</h5>
            <p>Company and teams</p>
            <p>Security</p>
            <p>Press</p>
            <p>Career</p>
        ...
        <div>
          ...
          <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
